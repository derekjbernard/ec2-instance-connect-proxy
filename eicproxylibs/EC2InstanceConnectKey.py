...
# --------------------------------------------------------------------
# Modifications by Derek Bernard github.com/derekjbernard
#   * Added key_path and bits params to EC2InstanceConnectKey class
...
class EC2InstanceConnectKey(object):
    ...
    """
    def __init__(self, logger, key_path=None):
        """
        ...
        :param key_path: Optional: Predefined IdentityFile path so ssh can use key generated by ProxyCommand.
        :type str: Predefined path to store temp private key.
        :param bits: bit size of generated key
        :type int:
        """
        self.logger = logger
    ...
    def _write_priv_key(self, _priv_key, key_path=None):
        ...
        :param key_path: optional: path to write key
        :type key_path: str
        """
        if key_path is None:
